...
{name:"Action",sort:{enabled:!1},formatter:(_, row) => gridjs.html(`<div class='d-flex gap-3'><a href='modify-proprety.php?id=${row.cells[6].data}&type=Riad' data-bs-toggle='tooltip' data-bs-placement='top' title='Edit' class='text-success'><i class='mdi mdi-pencil font-size-18'></i></a><a onclick='openmodal(${row.cells[6].data})' data-bs-toggle='tooltip' data-bs-placement='top' title='Delete' class='text-danger'><i class='mdi mdi-delete font-size-18'></i></a></div>`)}],pagination:{limit:8},sort:!0,search:!0,
server: {
    url: './PHP/riad.php',
...
.render(document.getElementById("table-riad")),flatpickr("#order-date",{defaultDate:new Date,dateFormat:"d M, Y"});
